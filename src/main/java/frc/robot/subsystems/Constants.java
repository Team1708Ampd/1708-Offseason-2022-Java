...
public class Constants {
    public static final double DRIVETRAIN_TRACKWIDTH_METERS = 0.53594;
    ...
    public static final double FRONT_LEFT_MODULE_STEER_OFFSET = -Math.toRadians(-104.854);

    public static final int FRONT_RIGHT_MODULE_DRIVE_MOTOR = 3;
    public static final int FRONT_RIGHT_MODULE_STEER_MOTOR = 2;
    public static final int FRONT_RIGHT_MODULE_STEER_ENCODER = 3;
    public static final double FRONT_RIGHT_MODULE_STEER_OFFSET = -Math.toRadians(-317.725);
    ...
    public static final double BACK_LEFT_MODULE_STEER_OFFSET = -Math.toRadians(-333.545);
    ...
    public static final double BACK_RIGHT_MODULE_STEER_OFFSET = -Math.toRadians(-128.496);
}
