package frc.robot.SwerveDriveLib.ctre;

import com.ctre.phoenix.motorcontrol.*;
import com.ctre.phoenix.motorcontrol.can.TalonFXConfiguration;
import com.ctre.phoenix.motorcontrol.can.WPI_TalonFX;
import frc.robot.SwerveDriveLib.DriveController;
import frc.robot.SwerveDriveLib.DriveControllerFactory;
import frc.robot.SwerveDriveLib.ModuleConfiguration;
...
public final class Falcon500DriveControllerFactoryBuilder {
    ...
    private class FactoryImplementation implements DriveControllerFactory<ControllerImplementation, Integer> {
        ...
        public ControllerImplementation create(Integer id, String canbus, ModuleConfiguration moduleConfiguration) {
            ...
            WPI_TalonFX motor = new WPI_TalonFX(id, "Hannibal the CANibal");
